...
const ICON_SVGS = {
  ...
  `,
      ...
      buck: `
    <svg viewBox="0 0 24 24" class="wp-svg" xmlns="http://www.w3.org/2000/svg">
      <!-- Buck: solid side-profile head/neck + antlers -->
      <path
        d="
          M7.2 18
          L9.4 13.1
      ...
      <!-- Ear -->
      <path
        d="M11.3 5.1 L12.7 4.2 L12.9 5.8 Z"
        fill="var(--wp-pin-icon)"
      />
      <!-- Antlers -->
      <path
  ...
  doe: `
    <svg viewBox="0 0 24 24" class="wp-svg" xmlns="http://www.w3.org/2000/svg">
      <!-- Doe: solid side-profile head/neck, no antlers -->
      <path
        d="
          M7.4 18
          L9.3 13.1
          Q10.2 11.1 11.8 10.1
          L14.5 8.6
          Q15.4 8.1 15.9 7.4
          Q16.4 6.7 16.4 6.0
          Q16.3 5.3 15.9 4.8
      ...
      <!-- Ear -->
      <path
        d="M11.0 5.0 L12.3 4.1 L12.4 5.6 Z"
        fill="var(--wp-pin-icon)"
      />
    </svg>
  `,
