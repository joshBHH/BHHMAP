...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('btnDeleteMode')?.addEventListener('click', () => {
    ...
    btn.style.background = deleteMode ? '#440000' : '';
  });

  // Wind placeholder
  document.getElementById('menuWind')?.addEventListener('click', () => {
    alert('Wind + Scent Cone coming in the next update!');
  });
  ...
  console.log("Buckeye Hunter Hub Map – 100% FIXED – No errors, logo loads, buttons work – Nov 19 2025");
});
